1)Чтение текстового файла: Программа начинает с чтения содержимого текстового файла, который пользователь указывает в качестве аргумента командной строки.
